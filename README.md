...
5. Update `generate_cv.py` preamble (lines 230-277) with your author information and run a replace all of Vinny Raster with your own name.
...
The script reads content from `pages/1-about.md`, `pages/4-publications.md`, `pages/3-portfolio.md`, `pages/2-services.md`, and `pages/5-testimonials.md`, then generates a `cv.typ` file with all CV sections.
